...
# --- CONFIGURATION ---
TOKEN = "8949058181:AAGVlRaaHNHfSjPtwC4kpL-6rQd667yyR4o" 
ADMIN_ID = 7976879259
bot = telebot.TeleBot(TOKEN)

# Force Join Channels
MUST_JOIN = ["@kaluarmyy", "@kaluedits", "@kalulikegroup", "@kiteflexx"]
...
def welcome(message):
    ...
    if not check_must_join(message.from_user.id):
        markup = types.InlineKeyboardMarkup()
        markup.row(types.InlineKeyboardButton("JOIN CHANNEL", url="https://t.me/kaluarmyy"))
        markup.row(types.InlineKeyboardButton("JOIN CHANNEL", url="https://t.me/kaluedits"))
        markup.row(types.InlineKeyboardButton("JOIN CHANNEL", url="https://t.me/kalulikegroup"))
        markup.row(types.InlineKeyboardButton("JOIN CHANNEL", url="https://t.me/kiteflexx"))
...
def admin_panel(message):
    bot.send_message(message.chat.id, "<b> KITE FLEX ADMIN PANEL</b>\n\nWelcome", reply_markup=admin_keyboard(), parse_mode="HTML")
